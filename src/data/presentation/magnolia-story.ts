...
export const magnoliaScenes: PursuitScene[] = [
  ...
  },
  {
    ...
    body: "Unitized curtain wall, stick curtain wall, storefront, and entrance systems are resolved as one connected glazing package.",
    image: "/images/magnolia/04-north-elevation.png",
    durationMs: 9000,
    metrics: [
      { label: "Unitized", value: "GW-7000" },
      { label: "Stick System", value: "ES-7525" },
    ...
    presenterNote: {
      lead: "Establish the four-system glazing family before presenting specifications.",
      talkingPoints: [
        "Interfaces between curtain wall and entrances are part of the same coordination path.",
        "The system mix supports performance without fragmenting responsibility.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    title: "Performance reaches the detail.",
    body: "Bullnose transitions and lower-iron glass preserve the performance profile while sharpening the architectural expression.",
    image: "/images/magnolia/01-southeast-oblique.png",
    durationMs: 9400,
    metrics: [
      { label: "Detail", value: "GW-7000 Bullnose" },
      { label: "Glass", value: "Lower-Iron Option" },
      { label: "Finish", value: "Controlled Transition" },
    ],
    evidence: [
    ...
    hotspotIds: ["curtain-wall"],
    presenterNote: {
      lead: "Move from system family to the details stakeholders can see.",
      talkingPoints: [
        "The bullnose is resolved without stepping outside the tested system profile.",
        "Lower-iron glass is framed as a clarity and daylight decision.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    presenterNote: {
      lead: "State the screening scope in exact terms before showing the engineered details.",
      talkingPoints: [
        "The screen balances ventilation, durability, and architectural expression.",
        "ES Metals provides the perforated panel and tube-frame system as one scope.",
      ],
    },
  ...
  },
  {
    ...
    title: "Designed in elevation, section, plan, and three dimensions.",
    body: "Panel perforation, tube framing, mullion spacing, attachment, and buildable geometry stay connected to the presentation record.",
    image: "/images/magnolia/03-west-elevation.png",
    durationMs: 9800,
    metrics: [
      { label: "Panel", value: "3mm Perforated" },
      { label: "Views", value: "Elevation + Section" },
      { label: "Engineering", value: "ES Metals" },
    ],
    evidence: [{ sourceId: sourceId(11), label: "Elevation, section, plan, and isometric" }],
    sourcePageIds: [sourceId(11)],
    hotspotIds: ["garage-screen"],
    presenterNote: {
      lead: "Use the real detail sheet to prove the screen is engineered, not decorative shorthand.",
      talkingPoints: [
        "The source page carries all four view types and key heights.",
        "The presentation keeps that evidence available without turning into a PDF viewer.",
      ],
    },
    decisionIds: ["screen-system"],
  },
